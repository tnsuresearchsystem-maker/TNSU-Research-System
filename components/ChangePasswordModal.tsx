  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setError(result.message || t('passwordChangeFail'));
      }
    } catch (err) {
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 animate-fade-in-up">
        ...
        {success ? (
          <div className="text-center py-8">
            ...
            <h4 className="text-lg font-bold text-gray-800">{t('passwordChangedSuccess')}</h4>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                required
              />
              <p className="text-xs text-gray-400 mt-1">{t('minCharHint')}</p>
            </div>
            ...
            <div className="flex space-x-3 mt-6 pt-4 border-t">
              ...
              >
                {loading ? <span className="animate-spin h-5 w-5 border-2 border-white border-t-transparent rounded-full"></span> : t('updatePasswordBtn')}
              </button>
            </div>
          </form>
        )}
